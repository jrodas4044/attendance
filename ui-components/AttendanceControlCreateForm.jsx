...
import { createAttendanceControl } from "./graphql/mutations";
const client = generateClient();
export default function AttendanceControlCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createAttendanceControl.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "AttendanceControlCreateForm")}
      {...rest}
    >
      <TextField
        label="Date"
