...
import { createStudentAttendance } from "./graphql/mutations";
const client = generateClient();
export default function StudentAttendanceCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setIsPresent(initialValues.isPresent);
    setErrors({});
  };
  const validations = {
    date: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createStudentAttendance.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "StudentAttendanceCreateForm")}
      {...rest}
    >
      <TextField
        label="Date"
