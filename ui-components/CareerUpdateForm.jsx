...
import { getCareer } from "./graphql/queries";
...
export default function CareerUpdateForm(props) {
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getCareer.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getCareer
        : careerModelProp;
  ...
  React.useEffect(resetStateValues, [careerRecord]);
  const validations = {
    name: [{ type: "Required" }],
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateCareer.replaceAll("__typename", ""),
            variables: {
              input: {
                id: careerRecord.id,
                ...modelFields,
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || careerModelProp)}
